...
prom_data = pd.get_dummies(slicerp('20180101', '20180108')['promotion_type'])
a = prom_data[prom_data.index == 1][1].sum()
prom('20180101', '20180108')
...
testing = preprocess('20180101', '20171225', '20171218', '20171201', '20180108', 0)
...
from sklearn.ensemble import GradientBoostingRegressor #Lowest MAPE with 1.07 atm.
